...
class PedidoProducto implements IAbm
{
    public $id;
    public $id_pedido;
    public $id_producto;
    ...
    public function crearRegistro() 
    {
        ...
        try
        {
            ...
            $consulta = $objAccesoDatos->prepararConsulta("INSERT INTO  pedido_producto (id_pedido, id_producto, id_usuario, cantidad, precio, estado, created_at, updated_at, activo) 
                                                                  VALUES (:id_pedido, :id_producto, :id_usuario, :cantidad, :precio, :estado, :created_at, :updated_at, :activo)");
